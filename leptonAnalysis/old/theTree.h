...
// Tue Dec 14 12:21:14 2004 by ROOT version 4.00/06
// from TTree theTree/Energy Loss Tree
// found on file: bigMuonFile.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("tauFile1e12Ice.root");
      if (!f) {
         f = new TFile("tauFile1e12Ice.root");
      }
